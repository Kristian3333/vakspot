...
async function main() {
  ...
  const categories = [
    ...
    { name: 'Vloeren', slug: 'flooring', icon: 'Square', description: 'Vloeren leggen en renoveren', order: 5 },
    { name: 'Dakdekker', slug: 'roofing', icon: 'Home', description: 'Dakwerk en reparaties', order: 6 },
    { name: 'Metselaar', slug: 'masonry', icon: 'Layers', description: 'Metselwerk en voegwerk', order: 7 },
    { name: 'Stukadoor', slug: 'plastering', icon: 'PaintRoller', description: 'Stucwerk en wanden', order: 8 },
    { name: 'Tuinman', slug: 'gardening', icon: 'Flower2', description: 'Tuinonderhoud en aanleg', order: 9 },
